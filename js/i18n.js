...
WCM.I18N = {
  en: {
    ...
    noMistakes:"No mistakes to review - great job!", dueNow:"Due", yourAnswer:"Your answer", cardAlbum:"Card Album", weakPoints:"Weak Points", mastery:"Mastery", gradeSelect:"Select Your Grade", grade1:"P3-P4 Forest Beginnings", grade2:"P5 Deep Forest", grade3:"P6 Path to StarClan", dailyCheckin:"Daily Hunt", dailyHuntBtn:"Start Daily Hunt", yourGrade:"Grade", aiAnalyze:"AI Mentor Analysis", aiAnalyzing:"Analyzing...", aiNotConfigured:"AI not configured yet",
  ...
  "zh-TW": {
    ...
    noMistakes:"沒有錯題需要重温，幹得好！", dueNow:"到期", yourAnswer:"你的答案", cardAlbum:"卡片相冊", weakPoints:"薄弱知識點", mastery:"掌握度", gradeSelect:"選擇你的年級", grade1:"P3-P4 森林初探", grade2:"P5 森林深處", grade3:"P6 星族之路", dailyCheckin:"今日打卡", dailyHuntBtn:"開始今日打卡", yourGrade:"年級", aiAnalyze:"AI 導師分析", aiAnalyzing:"分析中...", aiNotConfigured:"AI 尚未配置",
